...
const Footer = () => {
  return (
    <div className='pt-16 pb-16'>
      <div className='w-[80%] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10'>
        <div className='space-y-5'>
          ...
          <p className='text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950'>Gift Card</p>
        ...
        <div className='space-y-5'>
          ...
          <p className='text-gray-800 font-medium cursor-pointer text-sm hover:text-blue-950'>Legal</p>
        ...
        <div>
          ...
          <div className='mt-6'>
            ...
            <h1 className='text-base font-bold text-blue-950 mt-1'>bookmystay@gmail.com</h1>
          </div>
        </div>
      </div>
      <div className='mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm'>
        <p className='text-center md:text-left'>
           Copyright © 2025 BookMyStay. All rights reserved.
        </p>
