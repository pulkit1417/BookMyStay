...
const Newsletter = () => {
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
        <BsEnvelopePaper 
        className='w-16 h-16 mt-20 text-white'
        />
        ...
        <div className='w-full'>
            ...
            placeholder='Email'
            />
            <button className='px-6 py-3.5 bg-blue-900 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none hover:bg-blue-950 transition-all duration-200 text-white'>
                Subscribe
            </button>
        </div>
    </div>
