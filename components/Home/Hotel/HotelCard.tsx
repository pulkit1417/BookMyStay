  ...
  return (
    <div className=''>
        <div className='relative h-[300px] w-full rounded-lg cursor-pointer group overflow-hidden '>
            <div className='absolute top-4 right-4 z-20 w-10 h-10 bg-white rounded-full text-black flex items-center justify-center flex-col'>
        ...
        <div>
            ...
            <div className='flex items-center space-x-2'>
                <div className='px-2 py-2 bg-blue-800 rounded-md font-bold text-white text-sx'>
                    {hotel.rating}
                </div>
